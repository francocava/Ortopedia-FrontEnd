      ...
      <v-row align="center" no-gutters>
        <v-col>
          <v-card class="pa-2" outlined tile align="center">
            ...
            <v-card-text> <div class="red--text"><span class="red--text">Av. Rivadavia 8860</span></div>
      ...
      <v-row no-gutters>
        ...
        <v-col>
          <v-card outlined style="height: 150px">
            ...
            <v-card-text> Teléfono: {{ pedido.cliente.telefono }} </v-card-text>
          </v-card>
        </v-col>
      </v-row>
      <v-row>
...
<!--         <v-spacer></v-spacer>
        ...
        <v-spacer></v-spacer> -->
        <v-col>
          <v-card flat align="end" class="d-flex flex-row-reverse">
      ...
      <v-row>
        <v-col>
          <v-card outlined style="height: 150px">
            ...
            <v-card-text
              >- Condición de Pago: Pago previo a entrega</v-card-text
            >
