              ...
              <v-card-text>
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="editedItem.total_con_iva"
                        label="con IVA"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
                      <v-text-field
                        v-model="editedItem.total_sin_iva"
                        label="sin IVA"
                      ></v-text-field>
                    </v-col>
                    <v-col cols="12" sm="6" md="4">
...
export default {
  data: () => ({
    ...
    headers: [
      ...
      { text: 'Total con IVA', value: 'total_con_iva' },
      { text: 'sin IVA', value: 'total_sin_iva', sortable: true },
      { text: 'FL/CT', value: 'fl_ct', sortable: true },
